...
function getArtistByIndex(array, index) {
  let outputMessage =``;
  outputMessage = `the artist at index ${array[index].id} is ${array[index].name}`;
...
function get20s(array){
  let newArray = array.filter(array => array.years >= "1900" && array.years <= "2000");
  let newArray2 = newArray.map (newArray => newArray.name);
  return (newArray2);
}
...
function addArtist(array){
    const newArtist = {
      id: 20,
      name: "Chris Ramirez", 
      years: "1994 - May 2nd, 2020",
      genre: "Web Design", 
      nationality: "Nicaraguan",
      bio: "This is a bio about me. I am happy I am figuring this out finally"
    };
